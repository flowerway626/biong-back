...
import { createProduct, getSellProducts, getAllProducts, getSixProducts, getRecomProducts, getProduct, editProduct, delProduct } from '../controllers/products.js'
...
router.get('/recom', getRecomProducts)
